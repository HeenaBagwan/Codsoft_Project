...
const sendEmail = (e) =>{
    ...
    // serviceID - templateID - #form - publicKey
        emailjs.sendForm('service_wz742cm', 'template_l1nx5n9', '#contact-form', 'jq1VS5QG9zpPz2vea')
    .then(() => {
        // Show sent message
...
const scrollUp = () =>{
    ...
    // show -scroll class to the a tag with scrollup class
...
const getCurrnetTheme = () => document.body.classList.contains(darkTheme) ? 'dark' : 'light'
const getCurrnetIcon = () => themeButton.classList.contains(iconTheme) ? 'ri-moon-line' : 'ri-sun-line'
...
themeButton.addEventListener('click', () => {
    ...
    localStorage.setItem('selected-theme', getCurrnetTheme())
    localStorage.setItem('selected-icon',getCurrnetIcon())
})
